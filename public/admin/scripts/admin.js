...
if (categoriesCanvas) {
    ...
    new Chart(categoriesCtx, {
        type: 'pie', // or 'bar', 'line' depending on your intent
        data: {
    ...
    const geoCanvas = document.getElementById('locationChart');
    if (geoCanvas) {
        ...
        new Chart(geoCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [350, 480, 120, 90, 70], // Replace with your actual numbers
                    backgroundColor: [
                        'rgba(54, 162, 235, 0.7)',
                        'rgba(255, 99, 132, 0.7)',
                        'rgba(255, 206, 86, 0.7)',
